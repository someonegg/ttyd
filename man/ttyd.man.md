...
- `-t 'mobileKeyboardCustomKeys=[{"id":"tmux_copy_mode","label":"C-b [","combo":["Ctrl+b","["]}]'`: define custom dynamic keys (array of `{id,label,combo}`; `combo` is a sequence like `Ctrl+b`, `[`). `id` must match `^[a-z][a-z0-9_]{0,31}$`, and `__proto__`, `prototype`, `constructor` are forbidden. The default web UI predefines six tmux keys: `tmux_copy_mode` (`C-b [`), `tmux_detach` (`C-b d`), `tmux_new_window` (`C-b c`), `tmux_prev_window` (`C-b p`), `tmux_next_window` (`C-b n`), `tmux_list_windows` (`C-b w`)
- `-t 'mobileKeyboardLayouts=[["home","up","end","left","down","right"]]'`: set dynamic layouts for the top section (6 keys per layout). In the default web UI, 3 pages are active by default: page 1 `["home","up","end","left","down","right"]`, page 2 `["enter","up","batch_input","left","down","right"]`, page 3 `["pageup","tmux_copy_mode","pagedown","tmux_prev_window","tmux_next_window","tmux_list_windows"]`
