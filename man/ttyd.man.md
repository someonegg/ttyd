...
- `-t 'mobileKeyboardLayouts=[["home","up","end","left","down","right"]]'`: set dynamic layouts for the top section (6 keys per layout). In the default web UI, 3 pages are active by default: page 1 `["home","up","end","left","down","right"]`, page 2 `["pageup","up","pagedown","left","down","right"]`, page 3 `["enter","tmux_copy_mode","tmux_detach","tmux_new_window","tmux_next_window","tmux_list_windows"]`
